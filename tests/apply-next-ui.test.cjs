...
(async () => {
  ...
  assert.match(uiSource, /const canAffectFresh = age !== null && age <= FRESH_MAX_AGE_DAYS && potentialTotal >= freshCutoff;/, "Fresh distance work should not pull stale jobs into the shortlist");
