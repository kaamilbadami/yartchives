...
assert.deepEqual(
  workflowFiles,
  ["auto-merge-agent-prs.yml", "autonomous-dispatch.yml", "cleanup-closed-pr-branches.yml", "coverage-audit.yml", "coverage-automation.yml", "deploy-pages.yml", "quality.yml", "refresh-inspections.yml", "triage-workflow-failures.yml", "update-feed.yml"],
