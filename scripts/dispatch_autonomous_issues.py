...
def session_prompt(
    ...
    prompt = (
        ...
        "'bash scripts/run_quality_checks.sh all', push the branch, and require the exact "
        "branch head SHA to pass the repository's 'Branch preflight' checks. If preflight "
